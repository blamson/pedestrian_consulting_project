...
methods_hsm = st.Page("app_pages/2_Methods_HSM_Intro.py", title="HSM Framework")
methods_spfs = st.Page("app_pages/3_Methods_SPFs.py", title="Safety Performance Functions")
methods_cmfs = st.Page("app_pages/4_Methods_CMFs.py", title="Crash Modification Factors")
data = st.Page("app_pages/5_Data_Acquisition.py", title="Data Acquisition")
results = st.Page("app_pages/6_Results.py", title="Results")
